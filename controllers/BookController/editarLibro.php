...
if($_SERVER["REQUEST_METHOD"] === "POST"){
    ...
    $libro = LibroModel::find($_POST['id']);
    ...
    if($resultado){
        $respuesta = [
            'respuesta' => [
                ...
                'message' => 'Se ha editado el libro correctamente',
                'type'    => 'success',
            ]
        ];
    }else{
        $respuesta = [
            'respuesta' => [
                ...
                'message' => 'Ha ocurrido un error al editar los datos del libro, por favor intente nuevamente.',
                'type'    => 'error',
            ]
        ];
    }
